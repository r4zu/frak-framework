...
class FrakRouter {
  /**
   * Constructor for the FrakRouter class.
   *
  ...
  constructor(element, routes, root) {
    ...
    // This function handles browser navigation event.
    function onNavigate() {
  ...
  loadRoute(...urlSegs) {
    ...
    routerOutElem.innerHTML = matchedRoutes.template;
  }
   ...
   * @returns {Object} The matched route of undefined if no match found.
   */
...
// Export the FrakRouter class for external use.
export default FrakRouter;
