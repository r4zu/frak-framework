...
// @lit-labs/ssr provides server-side rendering capabilities for the lit componnets.
import { render } from '@lit-labs/ssr';

// html is a tagged template function from the `lit`library to define lit-html template.
...
// Creating a debugger specific to "frak:frontend-renderer".
const debug = makeDebug('frak:frontend-renderer');
...
class Renderer {
  ...
  async render(component, request, response, options) {
    ...
    const entrypoint = `<script type="module">await import("/component/${this.name}.js");</script>`;
    debug(`Entrypoint file ${entrypoint}`);
    // Invonking the provided component function to get the component's render result.
          ...
          <script type="importmap">
            {
              "import": {
                ...
                "lit-html/is-server.js": "/_framework/list-html/is-server.js"
              }
            }
          </script>
