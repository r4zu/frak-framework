// Importing required module and utilities.

// `makeDebug` is a function from the "debug" package for creating a debugger instance.
import makeDebug from 'debug';
// Creating a debug instance specifically for "frak:optimize"
const debug = makeDebug('frak:optimize');
...
class Optimize {
  ...
  /**
   * Minify all JavaScript files in the components directory and save them to .frak/components.
  ...
  async minifyScripts() {
    ...
    const destDir = join(process.cwd(), '.frak/components');
