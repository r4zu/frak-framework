...
// Creating a debug instance specifically for "frak:frontend-client-view"
const debug = makeDebug('frak:frontend-client-view');
...
class ClientView {
   ...
   * @throw Will throw an error if the component is not found or not a function.
   */
